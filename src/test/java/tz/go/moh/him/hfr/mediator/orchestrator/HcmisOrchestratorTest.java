...
import tz.go.moh.him.hfr.mediator.mock.MockHcmis;
 ...
 */
public class HcmisOrchestratorTest extends BaseOrchestratorTest {
    ...
    public void before() {
        ...
        actorsToLaunch.add(new MockLauncher.ActorToLaunch("http-connector", MockHcmis.class));
    ...
    public void testNewFacilityHfrRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            final ActorRef orchestrator = system.actorOf(Props.create(HcmisOrchestrator.class, configuration));

            InputStream stream = HcmisOrchestratorTest.class.getClassLoader().getResourceAsStream("new_facility_request.json");
    ...
    public void testUpdateFacilityHfrRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            ...
            InputStream stream = HcmisOrchestratorTest.class.getClassLoader().getResourceAsStream("update_facility_request.json");
